...
#define EXYNOS7872_PA_DREX_PF		0x10410000
#define EXYNOS7872_PA_SYSREG_IS		0x144C0000
...
#define PORT_TOKEN_CONTROL		0x20
#define PORT_TOKEN_THRESHOLD0		0x24

#define XIU_D_IS_M0			0x400
#define XIU_D_IS_S2			0x40C
#define XIU_D_IS_S3			0x410
