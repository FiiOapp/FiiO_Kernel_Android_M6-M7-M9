...
#define HV_DPRESET_VAL		0x00
#define HV_DNSRC_VAL		0x01
#define HV_DPRESET_BIT		2
#define HV_DPRESET_MASK		(0x3 << HV_DPRESET_BIT)

#define HV_DPDNVdEN_VAL		1
#define HV_DPDNVdEN_BIT		4
#define HV_DPDNVdEN_MASK	(0x1 << HV_DPDNVdEN_BIT)
...
static void hv_reset_afc(struct hv_data *phv)
{
	...
	value |= HV_DPDNVdEN_VAL << HV_DPDNVdEN_BIT;

	mask = HV_DPRESET_MASK | HV_DPDNVdEN_MASK;

	max77865_muic_hv_update_reg(phv->i2c, MAX77865_MUIC_REG_CONTROL2_BC, value, mask, true);
