...
struct pmucal_seq pmucal_lpm_init[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "TCXO_SHARED_DURATION3", 0x11C80000, 0x371C, (0x3ff << 0), (0x31 << 0), 0, 0, 0xffffffff, 0),
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 30), (0x1 << 30), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 29), (0x1 << 29), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 1), (0x0 << 1), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 2), (0x0 << 2), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "WAKEUP_MASK_APM", 0x11C80000, 0x8400, (0x1 << 4), (0x0 << 4), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 1), (0x1 << 1), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 2), (0x1 << 2), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 4), (0x1 << 4), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 6), (0x0 << 6), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 7), (0x0 << 7), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "APM_MASK_PMU_IF", 0x11C80000, 0x00D0, (0x1 << 8), (0x0 << 8), 0, 0, 0xffffffff, 0),
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "IS_XIU_DRCT_EN", 0x144C0000, 0x1000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "PPMU_acg_enable", 0x144C0000, 0x1100, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MFCMSCL_DRCG_EN", 0x12CA0000, 0x3000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MIF_DREX0_DRCG_CON", 0x10510000, 0x0404, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MIF_BUS_RCG_EN_0", 0x10510000, 0x1000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MIF_BUS_RCG_EN_1", 0x10510000, 0x1004, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MIF_PPMU_ACG_ENABLE", 0x10510000, 0x1020, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
...
struct pmucal_seq save_sleep[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_COND_SAVE_RESTORE, "PLL_CON0_PLL_AUD", 0x14800000, 0x1e0, (0x7ffffff << 5) | (0xf << 0), 0, 0x11C80000, 0x4024, (0xf << 0), (0xF << 0)),
	...
	PMUCAL_SEQ_DESC(PMUCAL_COND_CHECK_SKIP, "PLL_CON0_PLL_AUD", 0x14800000, 0x1e0, (0x1 << 31), (0x0 << 31), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_WAIT, "PLL_CON0_PLL_AUD", 0x14800000, 0x1e0, (0x1 << 29), (0x1 << 29), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0)),
	...
	PMUCAL_SEQ_DESC(PMUCAL_COND_SAVE_RESTORE, "QCH_CON_DPU_QCH_DECON0", 0x14800000, 0x3020, 0xffffffff, 0, 0x11C80000, 0x4024, (0xf << 0), (0xF << 0)),
	...
	PMUCAL_SEQ_DESC(PMUCAL_COND_SAVE_RESTORE, "IS_CMU_CONTROLLER_OPTION", 0x144B0000, 0x800, 0xffffffff, 0, 0x11C80000, 0x4064, (0xf << 0), (0xF << 0)),
...
struct pmucal_seq exit_sleep[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CENTRAL_SEQ_CONFIGURATION", 0x11C80000, 0x0200, (0x1 << 16), (0x1 << 16), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CENTRAL_SEQ_MIF_CONFIGURATION", 0x11C80000, 0x0240, (0x1 << 16), (0x1 << 16), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "PLL_CON0_PLL_G3D", 0x11400000, 0x120, (0x1 << 4), (0x0 << 4), 0x11C80000, 0x40A4, (0xf << 0), (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "PLL_CON0_PLL_AUD", 0x14800000, 0x1e0, (0x1 << 4), (0x0 << 4), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_CPUCL0_BUS_COMPONENT_DRCG_EN", 0x10910000, 0x0104, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_CPUCL1_BUS_COMPONENT_DRCG_EN", 0x10810000, 0x0200, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_DISPAUD_BUS_COMPONENT_DRCG_EN", 0x14820000, 0x0200, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_FSYS_BUS_COMPONENT_DRCG_EN", 0x13420000, 0x0104, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_G3D_BUS_COMPONENT_DRCG_EN", 0x11430000, 0x0104, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x40A4, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_IS_IS_XIU_DRCT_EN", 0x144C0000, 0x1000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4064, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_IS_PPMU_acg_enable", 0x144C0000, 0x1100, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4064, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_MFCMSCL_MFCMSCL_DRCG_EN", 0x12CA0000, 0x3000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4044, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "SYSREG_MIF_MIF_DREX0_DRCG_CON", 0x10510000, 0x0404, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4044, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_MIF_MIF_BUS_RCG_EN_0", 0x10510000, 0x1000, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_MIF_MIF_BUS_RCG_EN_1", 0x10510000, 0x1004, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_MIF_MIF_PPMU_ACG_ENABLE", 0x10510000, 0x1020, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "SYSREG_PERI_BUS_COMPONENT_DRCG_EN", 0x10030000, 0x0200, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "M2M_SCALER_P_SCALER_CFG_DRCG_ENABLE", 0x12C10000, 0x0004, (0x1 << 31), (0x1 << 31), 0x11C80000, 0x4044, (0xf << 0), (0xF << 31) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "M2M_SCALER_P_SCALER_CFG_SRAM_CG_EN", 0x12C10000, 0x0004, (0x1 << 28), (0x1 << 28), 0x11C80000, 0x4044, (0xf << 0), (0xF << 28) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "DPP_NS_DPP_VG0_DYNAMIC_GATING_EN", 0x14850000, 0x4A54, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "DPU_DMA_NS_IDMA_G0_DYNAMIC_GATING_EN", 0x148B0000, 0x1058, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "DPU_DMA_NS_IDMA_G1_DYNAMIC_GATING_EN", 0x148B0000, 0x2058, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "DPU_DMA_NS_IDMA_GF_DYNAMIC_GATING_EN", 0x148B0000, 0x3058, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_COND_WRITE, "DPU_DMA_NS_IDMA_VG0_DYNAMIC_GATING_EN", 0x148B0000, 0x4058, (0xffffffff << 0), (0xFFFFFFFF << 0), 0x11C80000, 0x4024, (0xf << 0), (0xF << 0) | (0xF << 0)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "TOP_BUS_MIF_OPTION - [3] (EMULATION_APM_IF)", 0x11C80000, 0x2C88, (0x1 << 3), (0x0 << 3), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "TOP_BUS_MIF_OPTION - [2] (EMULATION_DRAM)", 0x11C80000, 0x2C88, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "TOP_BUS_MIF_OPTION - [1] (EMULATION_BUS)", 0x11C80000, 0x2C88, (0x1 << 1), (0x0 << 1), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "TOP_BUS_MIF_OPTION - [0] (EMULATION_BUSMASTER)", 0x11C80000, 0x2C88, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
