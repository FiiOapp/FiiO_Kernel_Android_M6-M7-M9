			...
			u32 *max_margin_cit)
{
	...
	*max_margin_cit = sensor_peri->cis.cis_data->max_margin_coarse_integration_time;

	dbg_sen_itf("[%s](%d:%d) pclk(%d), line_length_pck(%d), frame_length_lines(%d), max_margin_cit(%d)\n",
