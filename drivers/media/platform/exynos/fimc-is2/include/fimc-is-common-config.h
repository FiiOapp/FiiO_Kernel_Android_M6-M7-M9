...
#define dbg_sensor(fmt, args...) \
	dbg_common(debug_sensor, "[SSD]", fmt, ##args)

#define dbg_actuator(fmt, args...) \
	dbg_common(debug_sensor, "[ACT]", fmt, ##args)

#define dbg_flash(fmt, args...) \
	dbg_common(debug_sensor, "[FLS]", fmt, ##args)

#define dbg_preproc(fmt, args...) \
	dbg_common(debug_sensor, "[PRE]", fmt, ##args)
...
#define dbg_resource(fmt, args...) \
	dbg_common(debug_device, "[RSC]", fmt, ##args)

#define dbg_core(fmt, args...) \
	dbg_common(debug_device, "[COR]", fmt, ##args)
...
#define dbg_hw(fmt, args...) \
	dbg_common(debug_hw, "[HW]", fmt, ##args)
#define mdbg_hw(fmt, instance, args...) \
	dbg_common(debug_hw, "[%d][HW]", fmt, instance, ##args)
#define sdbg_hw(fmt, object, args...) \
	dbg_common(debug_hw, "[HW:%s]", fmt, object->name, ##args)
#define msdbg_hw(fmt, instance, object, args...) \
	dbg_common(debug_hw, "[%d][HW:%s]", fmt, instance, object->name, ##args)
...
#define dbg_lib(fmt, args...) \
	dbg_common(debug_hw, "[LIB]", fmt, ##args)
