...
#define EXYNOS_PMU_PC_SYS_PWR_REG		0X1338
...
#define SELECT_DUMP_PC_NO_PG		BIT(17)
...
extern int exynos_enable_cp_dump_pc(void);
extern int exynos_disable_cp_dump_pc(void);
